...
export const SERVICES: Record<Locale, ServicePage[]> = {
  es: [
    { slug:"chatters-onlyfans", icon:"💬", color:"#00e5d4",
    ...
    { slug:"gestion-onlyfans", icon:"⚙️", color:"#8b5cf6",
    ...
    { slug:"marketing-onlyfans", icon:"📱", color:"#f59e0b",
    ...
    { slug:"ppv-onlyfans", icon:"💰", color:"#10b981",
    ...
    { slug:"anonimato-onlyfans", icon:"🔒", color:"#6366f1",
    ...
    { slug:"dmca-onlyfans", icon:"⚖️", color:"#ef4444",
    ...
    { slug:"creadoras-latinas-onlyfans", icon:"🌎", color:"#ec4899",
    ...
    { slug:"monetizar-onlyfans", icon:"📈", color:"#f59e0b",
    ...
    { slug:"agencia-onlyfans-profesional", icon:"🏆", color:"#00e5d4",
    ...
    { slug:"onlyfans-desde-cero", icon:"🚀", color:"#8b5cf6",
  ...
  en: [
    { slug:"onlyfans-chatters", icon:"💬", color:"#00e5d4",
    ...
    { slug:"onlyfans-management-agency", icon:"⚙️", color:"#8b5cf6",
    ...
    { slug:"onlyfans-growth-strategy", icon:"📱", color:"#f59e0b",
    ...
    { slug:"onlyfans-ppv-strategy", icon:"💰", color:"#10b981",
    ...
    { slug:"anonymous-onlyfans", icon:"🔒", color:"#6366f1",
  ...
  fr: [
    { slug:"chatteuses-onlyfans", icon:"💬", color:"#00e5d4",
    ...
    { slug:"marketing-onlyfans-france", icon:"📱", color:"#f59e0b",
    ...
    { slug:"ppv-onlyfans-strategie", icon:"💰", color:"#10b981",
    ...
    { slug:"agence-onlyfans-mym", icon:"🏆", color:"#ec4899",
  ...
  de: [
    { slug:"onlyfans-chatter", icon:"💬", color:"#00e5d4",
    ...
    { slug:"onlyfans-management", icon:"⚙️", color:"#8b5cf6",
    ...
    { slug:"onlyfans-geld-verdienen", icon:"📈", color:"#f59e0b",
    ...
    { slug:"onlyfans-agentur-serioes", icon:"🏆", color:"#00e5d4",
  ...
  it: [
    { slug:"chatter-onlyfans", icon:"💬", color:"#00e5d4",
    ...
    { slug:"gestione-onlyfans", icon:"⚙️", color:"#8b5cf6",
    ...
    { slug:"marketing-onlyfans-italia", icon:"📱", color:"#f59e0b",
    ...
    { slug:"agenzia-onlyfans-professionale", icon:"🏆", color:"#10b981",
  ...
  pt: [
    { slug:"chatters-onlyfans-br", icon:"💬", color:"#00e5d4",
    ...
    { slug:"gestao-onlyfans", icon:"⚙️", color:"#8b5cf6",
    ...
    { slug:"marketing-onlyfans-brasil", icon:"📱", color:"#f59e0b",
    ...
    { slug:"ganhar-dinheiro-onlyfans", icon:"💰", color:"#10b981",
