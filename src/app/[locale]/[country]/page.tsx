...
const COUNTRY_META: Record<string, Record<string, { title:string; desc:string }>> = {
  es: {
    ...
    venezuela: { title:"OnlyFans en Venezuela: Ingresos en Dólares 2026 | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde Venezuela cobrando en dólares desde casa. Empieza de cero en Caracas o Maracaibo. Análisis gratis." },
    ...
    bolivia:   { title:"OnlyFans en Bolivia: Cuánto se Gana 2026 | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde Bolivia cobrando en dólares. Empieza desde cero en Santa Cruz, La Paz o Cochabamba. Análisis gratis." },
    paraguay:  { title:"OnlyFans en Paraguay: Cuánto se Gana 2026 | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde Paraguay cobrando en dólares. Guía para empezar y gestión profesional. Análisis gratis sin compromiso." },
    uruguay:   { title:"OnlyFans en Uruguay: Cuánto se Gana y Cómo Empezar | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde Uruguay cobrando en dólares. Empieza desde cero en Montevideo. Gestión profesional. Análisis gratis." },
    ...
    costarica: { title:"OnlyFans en Costa Rica: Cuánto se Gana 2026 | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde Costa Rica cobrando en dólares. Empieza desde cero en San José. Gestión profesional. Análisis gratis." },
    ...
    honduras:  { title:"OnlyFans en Honduras: Cuánto se Gana 2026 | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde Honduras cobrando en dólares. Empieza desde cero y multiplica tus ingresos. Análisis gratis." },
    elsalvador:{ title:"OnlyFans en El Salvador: Cuánto se Gana 2026 | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde El Salvador cobrando en dólares. Guía para empezar, cuánto se gana y gestión profesional. Análisis gratis." },
    nicaragua: { title:"OnlyFans en Nicaragua: Cuánto se Gana 2026 | Only Sweety", desc:"Cómo ganar dinero en OnlyFans desde Nicaragua y Managua. Cobra en dólares, empieza de cero y multiplica tus ingresos. Análisis gratis." },
  },
  en: {
