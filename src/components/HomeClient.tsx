...
export function ApplyForm({ locale, href }: { locale: string; href: string }) {
  ...
  const T = ({
    es:{title:"¿Lista para empezar?",sub:"Análisis gratuito en menos de 24h · Sin compromiso",name:"Tu nombre completo",prefix:"Prefijo",phone:"Número WhatsApp",ig:"Instagram o TikTok principal",social2:"Otra red social (opcional)",social3:"Otra más (opcional)",addSocial:"+ Añadir otra red social",email:"Email",monthly:"¿Cuánto ganas ahora?",monthlyPh:"Ej: $500/mes, $2.000/mes...",monthlyOpts:["Aun no tengo cuenta","$0 - acabo de empezar","Menos de $500/mes","$500 - $1.000/mes","$1.000 - $3.000/mes","$3.000 - $5.000/mes","Mas de $5.000/mes"],goal:"¿Cuánto quieres ganar?",country:"País",availability:"Disponibilidad diaria",notes:"Cuéntanos tu caso (opcional)",notesPh:"Ej: Llevo 3 meses, gano $500/mes, quiero llegar a $3.000...",submit:"Solicitar análisis gratuito →",ok:"¡Recibido! 🎉 Abriendo WhatsApp...",err:"Error al enviar. Prueba de nuevo o escríbenos directamente.",goals:["Empezar desde cero (no tengo cuenta)","Pasar de $0 a $1.000/mes","Pasar de $500 a $3.000/mes","Pasar de $1.000 a $5.000/mes","Superar $5.000/mes","Ya gano bien, quiero agencia","Otro"],avail:["1 hora al día","Hasta 5 horas al día","Hasta 8 horas al día","Todo el día"],note:"Sin compromiso · Sin cuota inicial · 100% confidencial",req:"Campo obligatorio",badPhone:"Número inválido",badEmail:"Email inválido"},
    en:{title:"Ready to start?",sub:"Free analysis in under 24h · No commitment",name:"Your full name",prefix:"Prefix",phone:"WhatsApp number",ig:"Main Instagram or TikTok",social2:"Another social (optional)",social3:"One more (optional)",addSocial:"+ Add another social",email:"Email",monthly:"How much do you earn now?",monthlyPh:"E.g: $500/mo, $2,000/mo...",monthlyOpts:["No account yet","$0 - just starting","Under $500/mo","$500 - $1,000/mo","$1,000 - $3,000/mo","$3,000 - $5,000/mo","Over $5,000/mo"],goal:"How much do you want to earn?",country:"Country",availability:"Daily availability",notes:"Tell us your case (optional)",notesPh:"E.g: 3 months in, earning $500/mo, want to reach $3,000...",submit:"Request free analysis →",ok:"Received! 🎉 Opening WhatsApp...",err:"Error. Please try again or message us directly.",goals:["Start from scratch (no account)","$0 to $1,000/mo","Under $500 to $3,000/mo","$1,000 to $5,000/mo","Surpass $5,000/mo","Already earning, want agency","Other"],avail:["1 hour a day","Up to 5 hours a day","Up to 8 hours a day","All day"],note:"No commitment · No upfront fee · 100% confidential",req:"Required",badPhone:"Invalid number",badEmail:"Invalid email"},
    fr:{title:"Prête à commencer ?",sub:"Analyse gratuite en moins de 24h · Sans engagement",name:"Ton prénom et nom",prefix:"Préfixe",phone:"Numéro WhatsApp",ig:"Instagram ou TikTok principal",social2:"Autre réseau (optionnel)",social3:"Encore un (optionnel)",addSocial:"+ Ajouter un réseau",email:"Email",monthly:"Combien gagnes-tu actuellement ?",monthlyPh:"Ex: $500/mois, $2.000/mois...",monthlyOpts:["Pas encore de compte","0$ - je commence","Moins de 500$/mois","500 - 1.000$/mois","1.000 - 3.000$/mois","3.000 - 5.000$/mois","Plus de 5.000$/mois"],goal:"Combien veux-tu gagner ?",country:"Pays",availability:"Disponibilité quotidienne",notes:"Parle-nous de ton cas (optionnel)",notesPh:"Ex: 3 mois d'activité, $500/mois, veux atteindre $3.000...",submit:"Demander une analyse →",ok:"Reçu ! 🎉 Ouverture de WhatsApp...",err:"Erreur. Réessaie ou écris-nous directement.",goals:["Commencer de zero (pas de compte)","De 0$ a 1.000$/mois","De 500$ a 3.000$/mois","De 1.000$ a 5.000$/mois","Depasser 5.000$/mois","Je gagne bien, je veux une agence","Autre"],avail:["1h par jour","Jusqu'à 5h par jour","Jusqu'à 8h par jour","Toute la journée"],note:"Sans engagement · Sans frais · 100% confidentiel",req:"Obligatoire",badPhone:"Numéro invalide",badEmail:"Email invalide"},
    de:{title:"Bereit loszulegen?",sub:"Kostenlose Analyse in 24h · Unverbindlich",name:"Vollständiger Name",prefix:"Vorwahl",phone:"WhatsApp-Nummer",ig:"Haupt-Instagram oder TikTok",social2:"Weiteres Netzwerk (optional)",social3:"Noch eines (optional)",addSocial:"+ Weiteres Netzwerk",email:"E-Mail",monthly:"Wie viel verdienst du aktuell?",monthlyPh:"z.B: $500/Monat, $2.000/Monat...",monthlyOpts:["Noch kein Account","$0 - gerade angefangen","Unter $500/Monat","$500 - $1.000/Monat","$1.000 - $3.000/Monat","$3.000 - $5.000/Monat","Uber $5.000/Monat"],goal:"Wie viel willst du verdienen?",country:"Land",availability:"Tägliche Verfügbarkeit",notes:"Erzähl uns deinen Fall (optional)",notesPh:"z.B: 3 Monate aktiv, $500/Monat...",submit:"Kostenlose Analyse anfordern →",ok:"Erhalten! 🎉 WhatsApp wird geöffnet...",err:"Fehler. Bitte erneut versuchen.",goals:["Von Null starten (kein Account)","Von 0$ auf 1.000$/Monat","Von 500$ auf 3.000$/Monat","Von 1.000$ auf 5.000$/Monat","5.000$/Monat+","Verdiene gut, suche Agentur","Anderes"],avail:["1 Std/Tag","Bis 5 Std/Tag","Bis 8 Std/Tag","Den ganzen Tag"],note:"Unverbindlich · Keine Vorauszahlung · Vertraulich",req:"Pflichtfeld",badPhone:"Ungültige Nummer",badEmail:"Ungültige E-Mail"},
    it:{title:"Pronta a iniziare?",sub:"Analisi gratuita in meno di 24h · Senza impegno",name:"Nome completo",prefix:"Prefisso",phone:"Numero WhatsApp",ig:"Instagram o TikTok principale",social2:"Altro social (opzionale)",social3:"Un altro (opzionale)",addSocial:"+ Aggiungi altro social",email:"Email",monthly:"Quanto guadagni ora?",monthlyPh:"Es: $500/mese, $2.000/mese...",monthlyOpts:["Nessun account","$0 - appena iniziato","Meno di 500$/mese","500 - 1.000$/mese","1.000 - 3.000$/mese","3.000 - 5.000$/mese","Piu di 5.000$/mese"],goal:"Quanto vuoi guadagnare?",country:"Paese",availability:"Disponibilità giornaliera",notes:"Raccontaci il tuo caso (opzionale)",notesPh:"Es: 3 mesi attiva, $500/mese...",submit:"Richiedi analisi gratuita →",ok:"Ricevuto! 🎉 Apertura WhatsApp...",err:"Errore. Riprova o scrivici direttamente.",goals:["Iniziare da zero (no account)","Da 0$ a 1.000$/mese","Da 500$ a 3.000$/mese","Da 1.000$ a 5.000$/mese","Superare 5.000$/mese","Guadagno bene, voglio agenzia","Altro"],avail:["1 ora/giorno","Fino a 5 ore/giorno","Fino a 8 ore/giorno","Tutto il giorno"],note:"Senza impegno · Gratuito · Riservato",req:"Obbligatorio",badPhone:"Numero non valido",badEmail:"Email non valida"},
    pt:{title:"Pronta para começar?",sub:"Análise gratuita em menos de 24h · Sem compromisso",name:"Nome completo",prefix:"Prefixo",phone:"Número WhatsApp",ig:"Instagram ou TikTok principal",social2:"Outra rede (opcional)",social3:"Mais uma (opcional)",addSocial:"+ Adicionar rede social",email:"Email",monthly:"Quanto voce ganha agora?",monthlyPh:"Ex: $500/mês, $2.000/mês...",monthlyOpts:["Ainda sem conta","$0 - comecei agora","Menos de $500/mes","$500 - $1.000/mes","$1.000 - $3.000/mes","$3.000 - $5.000/mes","Mais de $5.000/mes"],goal:"Quanto quer ganhar?",country:"País",availability:"Disponibilidade diária",notes:"Conte-nos seu caso (opcional)",notesPh:"Ex: 3 meses ativa, $500/mês...",submit:"Solicitar análise gratuita →",ok:"Recebido! 🎉 Abrindo WhatsApp...",err:"Erro. Tente novamente ou escreva-nos diretamente.",goals:["Comecar do zero (sem conta)","De $0 a $1.000/mes","De $500 a $3.000/mes","De $1.000 a $5.000/mes","Superar $5.000/mes","Ja ganho bem, quero agencia","Outro"],avail:["1 hora/dia","Até 5 horas/dia","Até 8 horas/dia","O dia todo"],note:"Sem compromisso · Gratuito · Confidencial",req:"Obrigatório",badPhone:"Número inválido",badEmail:"Email inválido"},
  } as Record<string,{title:string;sub:string;name:string;prefix:string;phone:string;ig:string;social2:string;social3:string;addSocial:string;email:string;monthly:string;monthlyPh:string;monthlyOpts:string[];goal:string;country:string;availability:string;notes:string;notesPh:string;submit:string;ok:string;err:string;goals:string[];avail:string[];note:string;req:string;badPhone:string;badEmail:string}>);
  ...
  return(
    <form name="aplicar" onSubmit={send} autoComplete="on" style={{position:"relative",zIndex:1}}>
      ...
      <div className="form-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
        <select aria-label={tx.monthly} style={selStyle(false)} value={d.monthly} onChange={e=>setD({...d,monthly:e.target.value})}>
            <option value="">{tx.monthly}</option>
            {tx.monthlyOpts.map(o=><option key={o} value={o}>{o}</option>)}
          </select>
